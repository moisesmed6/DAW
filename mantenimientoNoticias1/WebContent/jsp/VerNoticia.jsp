	...
	<div class="container">
     ...
     <!--<div data-scrollReveal="enter bottom and move 50px over 1s" class="jumbotron">
      ...
      <div class="panel panel-default">
 		 <div class="panel-heading text-center"><h2>Detalles</h2></div>     
      ...
      <table class="table table-hover table-bordered table-striped text-center">
       <tr>
        ...
        <tr>
          ...
          <td><a class="btn btn-primary" href="<%=base%>?action=anadirItem&agendaId=<%=agenda.getId()%>">Comprar</a></td>
        </tr>
      </table>
<%
      }
