	...
	<div class="container">
     ...
     <!--<div data-scrollReveal="enter bottom and move 50px over 1s" class="jumbotron">
      ...
      <div class="panel panel-default">
 		 <div class="panel-heading text-center"><h2>Borrar libro</h2></div>   
...
<%
  ...
  %>
      <table class="table table-hover table-bordered table-striped text-center">
        <tr>
          <td><p>�Esta seguro que desea borrar este libro?</p></td>
        </tr>
        <tr>
          <td>
          <form action="">
            <b><%=agenda.getCabecera()%></b>
...
<%
    	 ...
    	 %> 
            <div class="panel-body text-center">
              <h2>El libro se ha eliminado con exito</h2>
    	  </div>
    	  <%
      }
    }
